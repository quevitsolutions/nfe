    ...
    return (
        <div className="space-y-6 text-gray-300 leading-relaxed">
            ...
            <section className="mb-10">
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex gap-6">
                        <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-gradient-to-br from-red-600 to-rose-800 text-white flex items-center justify-center font-black text-xl shadow-[0_0_20px_rgba(227,6,19,0.3)]">1</div>
                        <div>
                    ...
                    {/* Step 2 */}
                    <div className="flex gap-6">
                        <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-gradient-to-br from-red-600 to-rose-800 text-white flex items-center justify-center font-black text-xl shadow-[0_0_20px_rgba(227,6,19,0.3)]">2</div>
                        <div>
                    ...
                    {/* Step 3 */}
                    <div className="flex gap-6">
                        <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-gradient-to-br from-red-600 to-rose-800 text-white flex items-center justify-center font-black text-xl shadow-[0_0_20px_rgba(227,6,19,0.3)]">3</div>
                        <div>
            ...
            <section>
                ...
                <div className="p-4 bg-red-950/20 border border-red-500/20 rounded-xl text-rose-200 text-xs font-mono">
                    <strong className="uppercase">Tip:</strong> Most successful leaders aim for Layer 6 (Bronze) as quickly as possible to begin capturing a share of the daily global volume.
                </div>
            </section>
        </div>
    );
