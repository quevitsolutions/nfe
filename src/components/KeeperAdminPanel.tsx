...
export function KeeperAdminPanel() {
    ...
    return (
        <div className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-[0_4px_25px_rgba(0,0,0,0.02)] relative overflow-hidden group">
            <div className="absolute top-0 right-0 -mt-10 -mr-10 opacity-[0.03] text-[#e30613] group-hover:scale-110 transition-transform duration-700">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8 relative z-10">
                <div className="flex items-center gap-5">
                    <div className="w-14 h-14 bg-slate-50 rounded-3xl flex items-center justify-center border border-slate-100 text-[#e30613]">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                             ...
                             <span className={`text-[10px] font-black uppercase tracking-widest ${health ? 'text-red-600' : 'text-slate-400'}`}>
            ...
            <div className="flex flex-col md:flex-row gap-4 relative z-10">
                <div className="flex-1 relative">
                    <input
                        ...
                        className="w-full bg-slate-50 border border-slate-100 rounded-[1.5rem] px-8 py-5 text-xs font-black text-slate-800 placeholder:text-slate-200 uppercase tracking-widest focus:outline-none focus:bg-white focus:border-[#e30613]/20 transition-all"
                    />
                </div>
                <button
                    onClick={handleSync}
                    disabled={loading || !syncNodeId}
                    className="px-10 py-5 bg-[#e30613] text-white rounded-[1.5rem] font-black text-xs uppercase tracking-widest shadow-xl shadow-[#e30613]/20 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-30 disabled:grayscale flex items-center justify-center gap-3"
                >
